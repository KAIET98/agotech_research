...
class mi_metereologia: 
    ...
    def meterelogia_estacion_mas_cercana(self, fecha_ini = None, fecha_fin = None):

        print('... extraemos la metereologia... ')
       ...
       # print(r.json())
        ...
        #no nos intereesa. 
            ...
            url = ("https://opendata.aemet.es/opendata/api/valores/climatologicos/diarios/datos"
                "/fechaini/{}T00:00:00UTC/fechafin/{}T00:00:00UTC/estacion/{}".format(self.fecha_ini, self.fecha_fin,\
